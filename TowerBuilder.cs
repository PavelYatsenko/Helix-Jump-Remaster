...
public class TowerBuilder : MonoBehaviour
{
    ...
    [SerializeField] private float _addiitonnalScale;
    ...
    public float BeamScaleY => _levelCount / 2f + _startAndFinishAdditionalScale + _addiitonnalScale / 2f;
    private void Awake()
    {
        Build();
    }
    ...
    private void Build()
    {
        ...
        spawnPosition.y += beam.transform.localScale.y - _addiitonnalScale;
